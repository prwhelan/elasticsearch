...
public class RequestExecutorServiceTests extends ESTestCase {
    ...
    public void testQueueSize_IsOne() {
        var service = createRequestExecutorServiceWithMocks();
        service.execute(RequestManagerTests.createMock(), new DocumentsOnlyInput(List.of(), false), null, new PlainActionFuture<>());
    ...
    public void testIsTerminated_AfterStopFromSeparateThread() {
        ...
        service.execute(
            ...
            new DocumentsOnlyInput(List.of(), false),
            null,
            listener
        );
    ...
    public void testExecute_AfterShutdown_Throws() {
        ...
        service.execute(requestManager, new DocumentsOnlyInput(List.of(), false), null, listener);
    ...
    public void testExecute_CallsOnFailure_WhenRequestTimesOut() {
        ...
        var listener = new PlainActionFuture<InferenceServiceResults>();
        service.execute(RequestManagerTests.createMock(), new DocumentsOnlyInput(List.of(), false), TimeValue.timeValueNanos(1), listener);
    ...
    public void testExecute_PreservesThreadContext() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        service.execute(RequestManagerTests.createMock(requestSender), new DocumentsOnlyInput(List.of(), false), null, listener);
    ...
    public void testChangingCapacity_ToZero_SetsQueueCapacityToUnbounded() throws IOException, ExecutionException, InterruptedException,
        ...
        service.execute(requestManager, new DocumentsOnlyInput(List.of(), false), null, new PlainActionFuture<>());
        assertThat(service.queueSize(), is(1));

        PlainActionFuture<InferenceServiceResults> listener = new PlainActionFuture<>();
        service.execute(RequestManagerTests.createMock(requestSender, "id"), new DocumentsOnlyInput(List.of(), false), null, listener);
    ...
    public void testRemovesRateLimitGroup_AfterStaleDuration() {
        ...
        service.execute(requestManager2, new DocumentsOnlyInput(List.of(), false), null, listener);
